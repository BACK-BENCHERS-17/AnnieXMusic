    ...
    if command == "Pause":
        ...
        if enabled:
            ...
            await callback.message.reply_text(
                f"<blockquote>"
                f"┌────── ˹ ᴀᴜᴛᴏᴘʟᴀʏ ˼─── ⏤‌‌●\n"
                f"┆{_BEAR} <b>ᴀᴜᴛᴏᴘʟᴀʏ ᴅɪsᴀʙʟᴇᴅ ❌</b>\n"
                f"┆{_TIME} <b>ᴋʜᴜsʜɪ ᴡɪʟʟ sᴛᴏᴘ ᴀғᴛᴇʀ ǫᴜᴇᴜᴇ ᴇɴᴅs.</b>\n"
                f"┆{_DOT} <b>ʙʏ :</b> {user_mention}\n"
                f"└──────────────────────●"
                f"</blockquote>\n"
            ...
            await callback.message.reply_text(
                f"<blockquote>"
                f"┌────── ˹ ᴀᴜᴛᴏᴘʟᴀʏ ˼─── ⏤‌‌●\n"
                f"┆{_BEAR} <b>ᴀᴜᴛᴏᴘʟᴀʏ ᴇɴᴀʙʟᴇᴅ ✅</b>\n"
                f"┆{_TIME} <b>ᴋʜᴜsʜɪ ᴡɪʟʟ ᴀᴜᴛᴏ-ᴘʟᴀʏ ʀᴇʟᴀᴛᴇᴅ sᴏɴɢs !</b>\n"
                f"┆{_DOT} <b>ʙʏ :</b> {user_mention}\n"
                f"└──────────────────────●"
                f"</blockquote>\n"
                f"<blockquote>{_AROW}</blockquote>",
