...
async def autoplay_command(cli, message: Message, _, chat_id):
    ...
    text = (
        ...
        f"┆{E_TIME} <b>ᴋʜᴜsʜɪ ᴀᴜᴛᴏ-ᴘʟᴀʏs ᴀ ɴᴇᴡ sᴏɴɢ ᴡʜᴇɴ ǫᴜᴇᴜᴇ ɪs ᴇᴍᴘᴛʏ</b>\n"
    ...
    if len(message.command) == 2:
        ...
        if arg == "on":
            ...
            return await message.reply_text(
                ...
                f"┆{E_TIME} <b>ᴋʜᴜsʜɪ ᴡɪʟʟ ᴀᴜᴛᴏ-ᴘʟᴀʏ ʀᴇʟᴀᴛᴇᴅ sᴏɴɢs !</b>\n"
                f"└──────────────────────●"
                f"</blockquote>\n"
                f"<blockquote>{ANNIE_ROW}</blockquote>",
            ...
            return await message.reply_text(
                ...
                f"┆{E_TIME} <b>ᴋʜᴜsʜɪ ᴡɪʟʟ sᴛᴏᴘ ᴀғᴛᴇʀ ᴄᴜʀʀᴇɴᴛ ǫᴜᴇᴜᴇ ᴇɴᴅs.</b>\n"
                f"└──────────────────────●"
                f"</blockquote>\n"
                f"<blockquote>{ANNIE_ROW}</blockquote>",
                reply_markup=close_markup(_),
