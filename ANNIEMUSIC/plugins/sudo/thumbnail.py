    ...
    return InlineKeyboardMarkup([
        [
            InlineKeyboardButton(
                ...
                callback_data="GTHUMB_TOGGLE_ON",
        ...
        [
            InlineKeyboardButton(
                ...
                callback_data="GTHUMB_TOGGLE_OFF",
...
async def thumbnail_command(client, message: Message):
    ...
    await message.reply_text(text, reply_markup=thumb_markup(enabled))


@app.on_callback_query(filters.regex("^GTHUMB_TOGGLE_") & OWNER_FILTER)
